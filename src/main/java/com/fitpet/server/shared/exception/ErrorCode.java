...
public enum ErrorCode {
    ...
    MISSION_NOT_FOUND(HttpStatus.NOT_FOUND, "M001", "해당 미션을 찾을 수 없습니다."),
    MISSION_ALREADY_EXISTS(HttpStatus.CONFLICT, "M002", "해당 날짜의 미션이 이미 존재합니다."),
    MISSION_CHECK_NOT_FOUND(HttpStatus.NOT_FOUND, "M003", "해당 미션 수행 기록을 찾을 수 없습니다."),
